            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Penjual: {{ $produk->user->name }}</p> <p class="card-text">
                        ...
                        <!-- Tombol Hapus -->
                        <a type="button" href="/adminhapus/{{ $produk->id }}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus produk ini?')">
                            Hapus
                        </a>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                            ...
                            <p><strong>Penjual:</strong> {{ $produk->user->name }}</p> </div>
