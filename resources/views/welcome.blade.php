...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('Toko') }}/css/vendor.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('Toko') }}/style.css">
...
<body>
        ...
        <div class="container-fluid">
            <div class="row py-3 border-bottom">
                ...
                <div class="col-sm-4 col-lg-3 text-center text-sm-start">
                    <div class="main-logo">
                        <a href="index.html">
                            <img src="{{ asset('Toko') }}/images/logo.png" alt="logo" class="img-fluid">
                        </a>
                    </div>
                </div>
    ...
    <section class="py-3"
        style="background-image: url('{{ asset('Toko') }}/images/background-pattern.jpg');background-repeat: no-repeat;background-size: cover;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="banner-blocks">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row banner-content p-5">
                                            ...
                                            <div class="img-wrapper col-md-5">
                                                <img src="{{ asset('Toko') }}/images/product-thumb-1.png"
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row banner-content p-5">
                                            ...
                                            <div class="img-wrapper col-md-5">
                                                <img src="{{ asset('Toko') }}/images/product-thumb-2.png"
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="banner-ad bg-success-subtle block-2"
                            style="background:url('{{ asset('Toko') }}/images/ad-image-1.png') no-repeat;background-position: right bottom">
                            <div class="row banner-content p-5">
                        ...
                        <div class="banner-ad bg-danger block-3"
                            style="background:url('{{ asset('Toko') }}/images/ad-image-2.png') no-repeat;background-position: right bottom">
                            <div class="row banner-content p-5">
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('Toko') }}/images/icon-vegetables-broccoli.png"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('Toko') }}/images/icon-bread-baguette.png"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Breads & Sweets</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('Toko') }}/images/icon-soft-drinks-bottle.png"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('Toko') }}/images/icon-wine-glass-bottle.png"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('Toko') }}/images/icon-animal-products-drumsticks.png"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('Toko') }}/images/icon-bread-herb-flour.png"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="{{ asset('Toko') }}/images/product-thumb-11.jpg"
                            ...
                            <div class="swiper-slide">
                                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="{{ asset('Toko') }}/images/product-thumb-12.jpg"
                                                class="img-fluid rounded" alt="Card title">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body py-0">
                            ...
                            <div class="swiper-slide">
                                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="{{ asset('Toko') }}/images/product-thumb-13.jpg"
                                                class="img-fluid rounded" alt="Card title">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body py-0">
                            ...
                            <div class="swiper-slide">
                                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="{{ asset('Toko') }}/images/product-thumb-14.jpg"
                                                class="img-fluid rounded" alt="Card title">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body py-0">
                                ...
                                <div
                                        ...
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('Toko') }}/images/thumb-bananas.png"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('Toko') }}/images/thumb-biscuits.png"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('Toko') }}/images/thumb-cucumber.png"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('Toko') }}/images/thumb-milk.png"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                ...
                                <div
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('Toko') }}/images/thumb-orange-juice.png"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('Toko') }}/images/thumb-raspberries.png"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                ...
                                <div
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('Toko') }}/images/thumb-tomatoes.png"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('Toko') }}/images/thumb-tomatoketchup.png"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="banner-ad bg-danger mb-3"
                        style="background: url('{{ asset('Toko') }}/images/ad-image-3.png');background-repeat: no-repeat;background-position: right bottom;">
                ...
                <div class="col-md-6">
                    <div class="banner-ad bg-info"
                        style="background: url('{{ asset('Toko') }}/images/ad-image-4.png');background-repeat: no-repeat;background-position: right bottom;">
                        <div class="banner-content p-5">
    ...
    <section class="py-5">
        <div class="container-fluid">
            ...
            <div class="bg-secondary py-5 my-5 rounded-5"
                style="background: url('{{ asset('Toko') }}/images/bg-leaves-img-pattern.png') no-repeat;">
            ...
            <div class="row">
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('Toko') }}/images/post-thumb-1.jpg" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('Toko') }}/images/post-thumb-2.jpg" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('Toko') }}/images/post-thumb-3.jpg" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
    ...
    <section class="py-5 my-5">
        <div class="container-fluid">
            ...
            <div class="bg-warning py-5 rounded-5"
                style="background-image: url('{{ asset('Toko') }}/images/bg-pattern-2.png') no-repeat;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{ asset('Toko') }}/images/phone.png" alt="phone"
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <img src="{{ asset('Toko') }}/images/app-store.jpg" alt="app-store">
                                <img src="{{ asset('Toko') }}/images/google-play.jpg" alt="google-play">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('Toko') }}/js/jquery-1.11.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous">
    </script>
    <script src="{{ asset('Toko') }}/js/plugins.js"></script>
    <script src="{{ asset('Toko') }}/js/script.js"></script>
</body>
